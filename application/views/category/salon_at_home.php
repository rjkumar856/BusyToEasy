      ...
      <div class="animate-switch-container" ng-switch on="stage" ng-class="{forward: direction, backward:!direction}">
        ...
        <div class="animate-switch1" ng-switch-when="stage2">
            ...
            <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                <label for="hair" class="switchery">Hair
                                    <input ng-required="true" id="hair" checked="" type="checkbox" name="trainer_gender[]" value="Hair" class="" ng-model="formParams.time_slot.time_slot_6_to_8_am" required ng-class="{'input-error': formValidation && multiStepForm.time_slot.time_slot_6_to_8_am.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="facial" class="switchery">Facial
                                    <input id="facial" checked="" type="checkbox" name="trainer_gender[]" value="Facial" class="" ng-model="formParams.time_slot.time_slot_8_to_10_am" required ng-class="{'input-error': formValidation && multiStepForm.time_slot.time_slot_8_to_10_am.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                             <div class="form-group">
                                <label for="others" class="switchery">Others
                                    <input id="others" checked="" type="checkbox" name="trainer_gender[]" value="Others" class="" ng-model="formParams.time_slot.time_slot_8_to_10_am" required ng-class="{'input-error': formValidation && multiStepForm.time_slot.time_slot_8_to_10_am.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                ...
                <div class="question_footer">
                        ...
                        <button type="button" class="btn btn-primary btn-3 btn-3d lnr icon-arrow-right" ng-click="checkbox_next('stage3')">Next</button>
                </div>
            </div>
        </div>
