    ...
    <div class="animate-switch-container" >
        <div class="animate-switch">
          <div class="row">
              ...
              <h2>What is the brand of your laptop?</h2>
              <div class="question_body">
                          <div class="form-group">
                                <label for="hp" class="switchery">HP
                                    <input id="hp" checked="" type="radio" name="gender" value="HP" ng-true-value="'HP'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="dell" class="switchery">Dell
                                    <input id="dell" checked="" type="radio" name="gender" value="Dell" ng-true-value="'Dell'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="lenovo" class="switchery">Lenovo
                                    <input id="lenovo" checked="" type="radio" name="gender" value="Lenovo" ng-true-value="'Lenovo'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="acer" class="switchery">Acer
                                    <input id="acer" checked="" type="radio" name="acer" value="Acer" ng-true-value="'Acer'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="asus" class="switchery">Asus
                                    <input id="asus" checked="" type="radio" name="asus" value="Asus" ng-true-value="'Asus'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="sony" class="switchery">Sony
                                    <input id="sony" checked="" type="radio" name="sony" value="Sony" ng-true-value="'Sony'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="toshiba" class="switchery">Toshiba
                                    <input id="toshiba" checked="" type="radio" name="toshiba" value="Toshiba" ng-true-value="'Toshiba'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="samsung" class="switchery">Samsung
                                    <input id="samsung" checked="" type="radio" name="samsung" value="Samsung" ng-true-value="'Samsung'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="hcl" class="switchery">HCL
                                    <input id="hcl" checked="" type="radio" name="hcl" value="HCL" ng-true-value="'HCL'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="ibm" class="switchery">IBM
                                    <input id="ibm" checked="" type="radio" name="ibm" value="IBM" ng-true-value="'IBM'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="others" class="switchery">Others
                                    <input id="others" checked="" type="radio" name="gender" value="Others" ng-true-value="'Others'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
      ...
      <div class="animate-switch-container" ng-switch on="stage" ng-class="{forward: direction, backward:!direction}">
        ...
        <div class="animate-switch1" ng-switch-when="stage2">
          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Service Guarantee</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> 30-day service guarantee post service completion</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Customer Protection of upto Rs.10,000 against damages</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Background checked and highly trained technicians</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> <a href="#">View Details</a></p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Genuine parts & fixed pricing</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> <a href="#">View Details</a></p>
                            </div>
                    <div class="row error alert alert-danger" ng-show="toggleFormErrorsView = formValidation && multiStepForm.gender.$error.required">
                        <ul>
        ...
        <div class="animate-switch1" ng-switch-when="stage3">
            ...
            <?php } ?>
          <div class="row">
              <h2>What is/are the issue(s) with the device?</h2>
              <div class="question_body">
                        
                            <div class="form-group">
                                <label for="battery" class="switchery">Battery
                                    <input id="battery" checked="" type="radio" name="type" value="Battery" ng-true-value="'Battery'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="hard-drive" class="switchery">Hard Drive
                                    <input id="hard-drive" checked="" type="radio" name="type" value="Hard Drive" ng-true-value="'Hard Drive'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="keyboard" class="switchery">Keyboard
                                    <input id="keyboard" checked="" type="radio" name="type" value="Keyboard" ng-true-value="'Keyboard'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="mic-speaker-not-working" class="switchery">Mic/speaker not working
                                    <input id="mic-speaker-not-working" checked="" type="radio" name="type" value="Mic/speaker not working" ng-true-value="'Mic/speaker not working'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="motherboard" class="switchery">Motherboard
                                    <input id="motherboard" checked="" type="radio" name="type" value="Motherboard" ng-true-value="'Motherboard'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="software-os" class="switchery">Software/OS
                                    <input id="software-os" checked="" type="radio" name="type" value="Software/OS" ng-true-value="'Software/OS'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="trackpad" class="switchery">Trackpad
                                    <input id="trackpad" checked="" type="radio" name="type" value="Trackpad" ng-true-value="'Trackpad'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="screen" class="switchery">Screen
                                    <input id="screen" checked="" type="radio" name="type" value="Screen" ng-true-value="'Screen'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="others" class="switchery">Others
                                    <input id="others" checked="" type="radio" name="type" value="Others" ng-true-value="'Others'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
