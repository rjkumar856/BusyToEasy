          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                ...
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Complete diagnosis of TV</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Identifying problems like power board, busted panel, etc</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Visiting charges if service not taken</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Installation</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Upto 50 inches - Rs. 499</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Above 50 inches - Rs. 599</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Uninstallation</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Upto 50 inches - Rs. 299</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Above 50 inches - Rs. 399</p>
                            </div>
                    <div class="row error alert alert-danger" ng-show="toggleFormErrorsView = formValidation && multiStepForm.gender.$error.required">
                        <ul>
                          <li ng-show="multiStepForm.$invalid">Select an option to continue</li>
