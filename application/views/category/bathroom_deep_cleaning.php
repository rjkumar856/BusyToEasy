          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                <label for="1-bathroom" class="switchery">1 bathroom
                                    <input id="1-bathroom" checked="" type="radio" name="gender" value="1 bathroom" ng-true-value="'1 bathroom'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="2-bathroom" class="switchery">2 bathroom
                                    <input id="2-bathroom" checked="" type="radio" name="gender" value="2 bathroom" ng-true-value="'2 bathroom'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="3-bathroom" class="switchery">3 bathroom
                                    <input id="3-bathroom" checked="" type="radio" name="gender" value="3 bathroom" ng-true-value="'3 bathroom'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="4-bathroom" class="switchery">4 bathroom
                                    <input id="4-bathroom" checked="" type="radio" name="gender" value="4 bathroom" ng-true-value="'4 bathroom'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="5-bathroom" class="switchery">5 bathroom
                                    <input id="5-bathroom" checked="" type="radio" name="gender" value="5 bathroom" ng-true-value="'5 bathroom'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
      ...
      <div class="animate-switch-container" ng-switch on="stage" ng-class="{forward: direction, backward:!direction}">
        ...
        <div class="animate-switch1" ng-switch-when="stage2">
          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">1 Bathroom</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Deep Cleaning of Floor WC Seat and Washbasin</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Deep Cleaning of all bathroom fittings.Deep Cleaning of mirror, window and floor</p>
                                ...
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">2 Bathroom</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Deep Cleaning of Floor WC Seat and Washbasin</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Deep Cleaning of all bathroom fittings.Deep Cleaning of mirror, window and floor</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Cleaning Time: 1-2 Hours, Cleaning Staff: 1</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Cleaning solutions: Professional grade cleaning solutions from Diversey</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">3 Bathroom</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Deep Cleaning of Floor, WC Seat, Washbasin, Bathroom fittings and Mirror</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Cleaning Time: 2-3 Hours, Cleaning Staff: 2</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">4 Bathroom</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Deep Cleaning of Floor, WC Seat, Washbasin, Bathroom fittings and Mirror</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Cleaning Time: 2-3 Hours, Cleaning Staff: 2</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">4 Bathroom</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Deep Cleaning of Floor, WC Seat, Washbasin, Bathroom fittings and Mirror</p>
