          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                <label for="microwave-oven-repair" class="switchery">Microwave Oven Repair
                                    <input id="microwave-oven-repair" checked="" type="radio" name="gender" value="Microwave Oven Repair" ng-true-value="'Microwave Oven Repair'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
