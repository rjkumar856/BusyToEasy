    ...
    <div class="animate-switch-container" >
        <div class="animate-switch">
          <div class="row">
              ...
              <h2>What is the brand of your mobile?</h2>
              <div class="question_body">
                          <div class="form-group">
                                <label for="samsung" class="switchery">Samsung
                                    <input id="samsung" checked="" type="radio" name="gender" value="Samsung" ng-true-value="'Samsung'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="xiaomi" class="switchery">Xiaomi
                                    <input id="xiaomi" checked="" type="radio" name="gender" value="Xiaomi" ng-true-value="'Xiaomi'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="motorola" class="switchery">Motorola
                                    <input id="motorola" checked="" type="radio" name="gender" value="Motorola" ng-true-value="'Motorola'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="oneplus" class="switchery">OnePlus
                                    <input id="oneplus" checked="" type="radio" name="gender" value="OnePlus" ng-true-value="'OnePlus'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="asus" class="switchery">Asus
                                    <input id="asus" checked="" type="radio" name="gender" value="Asus" ng-true-value="'Asus'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="htc" class="switchery">HTC
                                    <input id="htc" checked="" type="radio" name="gender" value="HTC" ng-true-value="'HTC'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="google" class="switchery">Google
                                    <input id="google" checked="" type="radio" name="gender" value="Google" ng-true-value="'Google'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="blackberry" class="switchery">Blackberry
                                    <input id="blackberry" checked="" type="radio" name="gender" value="Blackberry" ng-true-value="'Blackberry'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
    ...
    <form name="multiStepForm" class="form-validation" role="form" novalidate>
      <div class="animate-switch-container" ng-switch on="stage" ng-class="{forward: direction, backward:!direction}">
        ...
        <div class="animate-switch1" ng-switch-when="stage2">
            ...
            <?php } ?>
          <div class="row">
              <h2>Busy to Easy Advantage</h2>
              <div class="question_body">
                          <div class="form-group">
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Advantages</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> 30-day service guarantee</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Background checked and trained technicians</p>
                                ...
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Pricing & Terms</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> <a href="#">View Details</a></p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Service Details</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> <a href="#">View Details</a></p>
                            </div>
                    <div class="row error alert alert-danger" ng-show="toggleFormErrorsView = formValidation && multiStepForm.gender.$error.required">
                        <ul>
        ...
        <div class="animate-switch1" ng-switch-when="stage3">
            ...
            <?php } ?>
          <div class="row">
              <h2>Please Type your phone model</h2>
              <div class="question_body">
                          <div class="form-group">
                                    <input id="phone_model_name" type="text" placeholder="phone model name /phone model No." name="phone_model_name" value="Basic" class="" ng-model="formParams.phone_model_name" required ng-class="{'input-error': formValidation && multiStepForm.estimated_budget.$error.required}">
                            </div>
