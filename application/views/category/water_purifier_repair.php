    ...
    <div class="animate-switch-container" >
        <div class="animate-switch">
          <div class="row">
              ...
              <h2>Which RO brand you want to get Serviced/Repair?</h2>
              <div class="question_body">
                          <div class="form-group">
                                <label for="eureka-forbes" class="switchery">Eureka Forbes
                                    <input id="eureka-forbes" checked="" type="radio" name="eureka-forbes" value="Eureka Forbes" ng-true-value="'Eureka Forbes'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="kent" class="switchery">Kent
                                    <input id="kent" checked="" type="radio" name="kent" value="Kent" ng-true-value="'Kent'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="pureit" class="switchery">Pureit
                                    <input id="pureit" checked="" type="radio" name="pureit" value="Pureit" ng-true-value="'Pureit'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="others" class="switchery">Other Brands
                                    <input id="others" checked="" type="radio" name="others" value="Others Brands" ng-true-value="'Others Brands'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
      ...
      <div class="animate-switch-container" ng-switch on="stage" ng-class="{forward: direction, backward:!direction}">
        ...
        <div class="animate-switch1" ng-switch-when="stage2">
          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Repair/Servicing/Filter Change</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Cleaning of machine and all filters</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Filter change/Spare part(s) cost extra. Prices as per rate card</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Complete diagnosis of the machine</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Lowest Price Guarantee</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Spares at 40% lower price than market</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Best in Class Products</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> All products are certified and tested</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Pricing & Things to Know</h3>
        ...
        <div class="animate-switch1" ng-switch-when="stage3">
            ...
            <?php } ?>
          <div class="row">
              <h2>Which service do you need for the water purifier?</h2>
              <div class="question_body">
                        
                            <div class="form-group">
                                <label for="servicing" class="switchery">Servicing/Filter Change - Rs. 299
                                    <input id="servicing" checked="" type="radio" name="servicing" value="Servicing/Filter Change" ng-true-value="'Servicing/Filter Change'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="repair" class="switchery">Repair - Rs. 249
                                    <input id="repair" checked="" type="radio" name="repair" value="Repair" ng-true-value="'Repair'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="installation" class="switchery">Installation - Rs. 399
                                    <input id="installation" checked="" type="radio" name="installation" value="Installation" ng-true-value="'Installation'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="un-installation" class="switchery">Un-installation - Rs. 300
                                    <input id="un-installation" checked="" type="radio" name="un-installation" value="Un-installation" ng-true-value="'Un-installation'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
