          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                <label for="therapies" class="switchery">Therapies
                            ...
                            <div class="form-group">
                                <label for="packages" class="switchery">Packages
                            ...
                            <div class="form-group">
                                <label for="add_ons" class="switchery">Add-ons
                                    <input id="add_ons" checked="" type="radio" name="gender" value="Add-ons" ng-true-value="'Add-ons'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
      ...
      <div class="animate-switch-container" ng-switch on="stage" ng-class="{forward: direction, backward:!direction}">
        ...
        <div class="animate-switch1" ng-switch-when="stage2">
          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                <h3 class="switchery" style="font-size: 20px;text-align: left;"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Trained Therapist</h3>
                                <p class="prefpack_p">2+ years of experience</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Massage Bed</h3>
                                <p class="prefpack_p">We carry our own massage bed</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Unwind | De-stress</h3>
                                <p class="prefpack_p">With a relaxing massage at home</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Value for Money</h3>
                                <p class="prefpack_p">Massages starting at Rs. 1199/-</p>
                            </div>
                    <div class="row error alert alert-danger" ng-show="toggleFormErrorsView = formValidation && multiStepForm.gender.$error.required">
                        <ul>
                          <li ng-show="multiStepForm.$invalid">Select an option to continue</li>
