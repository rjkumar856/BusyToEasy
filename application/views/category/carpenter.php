          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="new-furniture-making" class="switchery">New Furniture Making
                                    <input id="new-furniture-making" checked="" type="radio" name="gender" value="New Furniture Making" ng-true-value="'New Furniture Making'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                ...
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Minimum booking amount of Rs 299 which includes inspection and 30 mins of service</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> 0 - 30 Min : Rs 299</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> 0.5 - 1 Hour : Rs 349</p>
                                ...
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Rs 299 as visiting/quotation charge if service is not availed</p>
                                ...
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">New Furniture Making</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Rs 299 for inspection and work quotation</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> This includes only inspection and quotation</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Note</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Sofa Upholstery, Wood Polishing and Aluminium Fabrication work is not included</p>
                            </div>
                    <div class="row error alert alert-danger" ng-show="toggleFormErrorsView = formValidation && multiStepForm.gender.$error.required">
                        <ul>
                          <li ng-show="multiStepForm.$invalid">Select an option to continue</li>
