    ...
    <div class="animate-switch-container" >
        <div class="animate-switch">
          <div class="row">
              ...
              <h2>What type of Refrigerator do you have?</h2>
              <div class="question_body">
                          <div class="form-group">
                                <label for="single-door" class="switchery">Single Door
                                    <input id="single-door" checked="" type="radio" name="single-door" value="Single Door" ng-true-value="'Single Door'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="double-door" class="switchery">Double Door
                                    <input id="double-door" checked="" type="radio" name="double-door" value="Double Door" ng-true-value="'Double Door'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="triple-door" class="switchery">Triple Door
                                    <input id="triple-door" checked="" type="radio" name="triple-door" value="Triple Door" ng-true-value="'Triple Door'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="side-by-side-door" class="switchery">Side by Side door
                                    <input id="side-by-side-door" checked="" type="radio" name="gender" value="Side by Side door" ng-true-value="'Side by Side door'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                ...
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Rs. 249 is the visiting charge of the technician in case you do not avail repairwork</p>
