          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                <label for="repairs-and-fixes" class="switchery">Repairs & Fixes
                                    <input id="repairs-and-fixes" checked="" type="radio" name="gender" value="Repairs & Fixes" ng-true-value="'Repairs & Fixes'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="standard-installation-services" class="switchery">Standard Installation Services
                                    <input id="standard-installation-services" checked="" type="radio" name="gender" value="Standard Installation Services" ng-true-value="'Standard Installation Services'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
