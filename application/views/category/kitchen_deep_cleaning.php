    ...
    <div class="animate-switch-container" >
        <div class="animate-switch">
          <div class="row">
              ...
              <h2>Select the number of Kitchens:</h2>
              <div class="question_body">
                          <div class="form-group">
                                <label for="1-kitchen" class="switchery">1 Kitchen
                                    <input id="1-kitchen" checked="" type="radio" name="gender" value="1 Kitchen" ng-true-value="'1 Kitchen'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="2-kitchen" class="switchery">2 Kitchens
                                    <input id="2-kitchen" checked="" type="radio" name="gender" value="2 Kitchen" ng-true-value="'2 Kitchen'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
      ...
      <div class="animate-switch-container" ng-switch on="stage" ng-class="{forward: direction, backward:!direction}">
        ...
        <div class="animate-switch1" ng-switch-when="stage2">
          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Kitchen Cleaning</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Exterior Deep Cleaning of Gas Stove and Chimney</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> De-greasing of granite shelves and tiles</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Cleaning Time: 2-3 Hours</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Cleaning Staff: 2</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Kitchen Cleaning with Utensil removal</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Exterior Deep Cleaning of Gas Stove and Chimney</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> De-greasing of granite shelves and tiles</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Cleaning Time: 2-3 Hours</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Cleaning Staff: 2</p>
