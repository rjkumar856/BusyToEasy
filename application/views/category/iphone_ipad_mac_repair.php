    ...
    <div class="animate-switch-container" >
        <div class="animate-switch">
          <div class="row">
              ...
              <h2>Which of your apple product needs repair?</h2>
              <div class="question_body">
                          <div class="form-group">
                                <label for="iphone" class="switchery">iPhone
                                    <input id="iphone" checked="" type="radio" name="iphone" value="iPhone" ng-true-value="'iPhone'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="ipad" class="switchery">iPad
                                    <input id="ipad" checked="" type="radio" name="ipad" value="iPad" ng-true-value="'iPad'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="ipod" class="switchery">iPod
                                    <input id="ipod" checked="" type="radio" name="ipod" value="iPod" ng-true-value="'iPod'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="macbook" class="switchery">MacBook
                                    <input id="macbook" checked="" type="radio" name="macbook" value="MacBook" ng-true-value="'MacBook'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
    ...
    <form name="multiStepForm" class="form-validation" role="form" novalidate>
      <div class="animate-switch-container" ng-switch on="stage" ng-class="{forward: direction, backward:!direction}">
          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                ...
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Busy to Easy Guarantee</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> 30-day service guarantee</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Protection against damages up to Rs.10,000</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Best Prices</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> If you decide not to go ahead with the repair charges are Rs. 249</p>
                            </div>
                    <div class="row error alert alert-danger" ng-show="toggleFormErrorsView = formValidation && multiStepForm.gender.$error.required">
                        <ul>
                          <li ng-show="multiStepForm.$invalid">Select an option to continue</li>
        ...
        <div class="animate-switch1" ng-switch-when="stage3">
            ...
            <?php } ?>
          <div class="row">
              <h2>Which part(s) are affected?</h2>
              <div class="question_body">
                          <div class="form-group">
                                    <input id="description_about_problem" type="text" placeholder="Description About Problem" name="description_about_problem" value="Basic" class="" ng-model="formParams.description_about_problem" required ng-class="{'input-error': formValidation && multiStepForm.estimated_budget.$error.required}">
                            </div>
