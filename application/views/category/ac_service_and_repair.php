          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                <label for="wet-servicing" class="switchery">Wet Servicing (Upto 50% Off)
                                    <input id="wet-servicing" checked="" type="radio" name="gender" value="Wet Servicing (Upto 50% Off)" ng-true-value="'Wet Servicing (Upto 50% Off)'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="repair" class="switchery">Repair - Rs. 249
                                    <input id="repair" checked="" type="radio" name="gender" value="Repair" ng-true-value="'Repair'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="installation" class="switchery">Installation
                                    <input id="installation" checked="" type="radio" name="gender" value="Installation" ng-true-value="'Installation'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="un-installation" class="switchery">Un-installation
                                    <input id="un-installation" checked="" type="radio" name="gender" value="Un-installation" ng-true-value="'Un-installation'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
    ...
    <form name="multiStepForm" class="form-validation" role="form" novalidate>
      <div class="animate-switch-container" ng-switch on="stage" ng-class="{forward: direction, backward:!direction}">
        ...
        <div class="animate-switch1" ng-switch-when="stage2">
            ...
            <?php } ?>
          <div class="row">
              <h2>Please select the type of ACs for installation</h2>
              <div class="question_body">
                          <div class="form-group">
                                <label for="window-ac" class="switchery">Window AC
                                    <input id="window-ac" checked="" type="radio" name="gender" value="Window AC" ng-true-value="'Window AC'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="split-ac" class="switchery">Split AC
                                    <input id="split-ac" checked="" type="radio" name="gender" value="Split AC" ng-true-value="'Split AC'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                    <div class="row error alert alert-danger" ng-show="toggleFormErrorsView = formValidation && multiStepForm.gender.$error.required">
        ...
        <div class="animate-switch1" ng-switch-when="stage3">
          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Wet Servicing (Upto 50% Off)</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Deep Cleaning the AC for fresh air</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Filter, coils etc. cleaned with water</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Save upto 20% on your summer electricity bill with regular servicing</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">AC not cooling properly/Repair - Rs. 249</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Complete diagnosis & repair</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Final charges based on inspection</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> 249/- visiting charge if no service taken</p>
                                ...
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Professional Servicing & Repair</h3>
