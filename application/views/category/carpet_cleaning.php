    ...
    <div class="animate-switch-container" >
        <div class="animate-switch">
          <div class="row">
              ...
              <h2>Select Carpet Type :</h2>
              <div class="question_body">
                          <div class="form-group">
                                <label for="small-carpet" class="switchery">Small (3 x 6 ft.)
                                    <input id="small-carpet" checked="" type="radio" name="gender" value="Small (3 x 6 ft.)" ng-true-value="'Small (3 x 6 ft.)'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="medium-carpet" class="switchery">Medium (5 x 9 ft.)
                                    <input id="medium-carpet" checked="" type="radio" name="gender" value="Medium (5 x 9 ft.)" ng-true-value="'Medium (5 x 9 ft.)'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="large-carpet" class="switchery">Large (8 x 12 ft.)
                                    <input id="large-carpet" checked="" type="radio" name="gender" value="Large (8 x 12 ft.)" ng-true-value="'Large (8 x 12 ft.)'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="extra-large-carpet" class="switchery">Extra Large (11 x 15 ft.)
                                    <input id="extra-large-carpet" checked="" type="radio" name="gender" value="Extra Large (11 x 15 ft.)" ng-true-value="'Extra Large (11 x 15 ft.)'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
      ...
      <div class="animate-switch-container" ng-switch on="stage" ng-class="{forward: direction, backward:!direction}">
        ...
        <div class="animate-switch1" ng-switch-when="stage2">
          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Small (3 x 6 ft.)</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Dry Vacuuming and shampooing using professional grade cleaning solution</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Cleaning Time: 1-2 Hours. Cleaning Staff: 1</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Medium (5 x 9 ft.)</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Dry Vacuuming and shampooing using professional grade cleaning solution</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Cleaning Time: 1-2 Hours. Cleaning Staff: 1</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Large (8 x 12 ft.)</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Dry Vacuuming and shampooing using professional grade cleaning solution</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Cleaning Time: 1-2 Hours. Cleaning Staff: 1</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Extra Large (11 x 15 ft.)</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Dry Vacuuming and shampooing using professional grade cleaning solution</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Cleaning Time: 1-2 Hours. Cleaning Staff: 1</p>
                            </div>
                    <div class="row error alert alert-danger" ng-show="toggleFormErrorsView = formValidation && multiStepForm.gender.$error.required">
