    ...
    <div class="animate-switch-container" >
        <div class="animate-switch">
          <div class="row">
              ...
              <h2>What type of Washing Machine do you have?</h2>
              <div class="question_body">
                          <div class="form-group">
                                <label for="front-load" class="switchery">Front Load
                                    <input id="front-load" checked="" type="radio" name="front-load" value="Front Load" ng-true-value="'Front Load'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="top-load" class="switchery">Top Load
                                    <input id="top-load" checked="" type="radio" name="top-load" value="Top Load" ng-true-value="'Top Load'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="others" class="switchery">Others
                                    <input id="others" checked="" type="radio" name="others" value="Others" ng-true-value="'Others'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                ...
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Expert Technicians</h3>
        ...
        <div class="animate-switch1" ng-switch-when="stage3">
          ...
          <div class="row">
              ...
              <div class="question_body">
                            ...
                            <div class="form-group">
                                <label for="installation-un-installation" class="switchery">Installation/Un-installation - Rs. 399
                                    <input id="installation-un-installation" checked="" type="radio" name="installation-un-installation" value="Installation/Un-installation" ng-true-value="'Installation/Un-installation'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
