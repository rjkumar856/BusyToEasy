    ...
    <div class="animate-switch-container" >
        <div class="animate-switch">
          <div class="row">
              ...
              <h2>Select the number of bathrooms :</h2>
              <div class="question_body">
                          <div class="form-group">
                                <label for="1-bhk-apartment" class="switchery">1 BHK Apartment
                                    <input id="1-bhk-apartment" checked="" type="radio" name="gender" value="1 BHK Apartment" ng-true-value="'1 BHK Apartment'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="2-bhk-apartment" class="switchery">2 BHK Apartment
                                    <input id="2-bhk-apartment" checked="" type="radio" name="gender" value="2 BHK Apartment" ng-true-value="'2 BHK Apartment'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="3-bhk-apartment" class="switchery">3 BHK Apartment
                                    <input id="3-bhk-apartment" checked="" type="radio" name="gender" value="3 BHK Apartment" ng-true-value="'3 BHK Apartment'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="4-bhk-apartment" class="switchery">4 BHK Apartment
                                    <input id="4-bhk-apartment" checked="" type="radio" name="gender" value="4 BHK Apartment" ng-true-value="'4 BHK Apartment'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="5-bhk-apartment" class="switchery">5 BHK Apartment
                                    <input id="5-bhk-apartment" checked="" type="radio" name="gender" value="5 BHK Apartment" ng-true-value="'5 BHK Apartment'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="villa" class="switchery">Villa
                                    <input id="villa" checked="" type="radio" name="gender" value="Villa" ng-true-value="'Villa'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
      ...
      <div class="animate-switch-container" ng-switch on="stage" ng-class="{forward: direction, backward:!direction}">
        ...
        <div class="animate-switch1" ng-switch-when="stage2">
          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Full Home Deep Cleaning</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Includes Bathroom, Kitchen, Living Room, Dining Room, Bedroom and Balcony Deep Cleaning</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Dry vacuuming of sofa, curtain and carpets</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Cleaning Time: 2 - 5 Hours</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Cleaning Staff: 1 - 3</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Cleaning solutions: Professional grade cleaning solutions from Diversey</p>
