    ...
    <div class="animate-switch-container" >
        <div class="animate-switch">
          <div class="row">
              ...
              <h2>Where are you shifting?</h2>
              <div class="question_body">
                          <div class="form-group">
                                <label for="within_city" class="switchery">Within city
                                    <input id="within_city" checked="" type="radio" name="within_city" value="Within city" ng-true-value="'Within city'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="outside_the_city" class="switchery">Outside the city
                                    <input id="outside_the_city" checked="" type="radio" name="outside_the_city" value="Outside the city" ng-true-value="'Outside the city'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
    ...
    <form name="multiStepForm" class="form-validation" role="form" novalidate>
      <div class="animate-switch-container" ng-switch on="stage" ng-class="{forward: direction, backward:!direction}">
        ...
        <div class="animate-switch1" ng-switch-when="stage2">
            ...
            <?php } ?>
          <div class="row">
              <h2>Busy To Easy Quality Promise</h2>
              <div class="question_body">
                          <div class="form-group">
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Superior packaging at best rates</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Packing of your goods in Bubble wrap, cargo sheets & corrugated boxes.</p>
                                
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Free insurance up to Rs. 10,000!</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> UrbanClap guarantees to ensure safety of your goods.<br> <a href="#">View Details</a></p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Trained & verified professionals</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Each professional is handpicked, trained and background checked by UrbanClap.</p>
                            </div>
                    <div class="row error alert alert-danger" ng-show="toggleFormErrorsView = formValidation && multiStepForm.gender.$error.required">
                        <ul>
                          <li ng-show="multiStepForm.$invalid">Select an option to continue</li>
        ...
        <div class="animate-switch1" ng-switch-when="stage3">
            ...
            <?php } ?>
          <div class="row">
              <h2>What do you want to shift?</h2>
              <div class="question_body">
                        
                            <div class="form-group">
                                <label for="very-few-items" class="switchery">Very few items
                                    <input id="very-few-items" checked="" type="radio" name="type" value="Very few items" ng-true-value="'Very few items'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="1bhk" class="switchery">1BHK
                                    <input id="1bhk" checked="" type="radio" name="type" value="1BHK" ng-true-value="'1BHK'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="2bhk" class="switchery">2BHK
                                    <input id="2bhk" checked="" type="radio" name="type" value="2BHK" ng-true-value="'2BHK'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="3bhk" class="switchery">3BHK
                                    <input id="3bhk" checked="" type="radio" name="type" value="3BHK" ng-true-value="'3BHK'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="4bhk" class="switchery">4BHK
                                    <input id="4bhk" checked="" type="radio" name="type" value="4BHK" ng-true-value="'4BHK'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="5bhk" class="switchery">5BHK
                                    <input id="5bhk" checked="" type="radio" name="type" value="5BHK" ng-true-value="'5BHK'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="bungalow/penthouse/villa" class="switchery">Bungalow/Penthouse/Villa
                                    <input id="bungalow/penthouse/villa" checked="" type="radio" name="type" value="Bungalow/Penthouse/Villa" ng-true-value="'Bungalow/Penthouse/Villa'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
        ...
        <div class="animate-switch1" ng-switch-when="stage5">
          ...
          <div class="row">
              ...
              <div class="question_body">
                            ...
                            <div class="form-group">
                                <input id="drop_off_location" type="text" placeholder="Please mention the exact location where you want to shift your goods." name="drop_off_location" value="Basic" class="" ng-model="formParams.drop_off_location" required ng-class="{'input-error': formValidation && multiStepForm.estimated_budget.$error.required}">
                            </div>
                    <div class="row error alert alert-danger" ng-show="toggleFormErrorsView = formValidation && multiStepForm.trainee_age.$error.required">
                        <ul>
                          <li ng-show="multiStepForm.$invalid">Select an option to continue</li>
        ...
        <div class="animate-switch1" ng-switch-when="success">
          <div class="success-wrap">
            ...
            <button type="button" class="btn btn-primary btn-3 btn-3d lnr icon-arrow-left" ng-click="back('stage9')">Back</button>
