    ...
    <div class="animate-switch-container" >
        <div class="animate-switch">
          <div class="row">
              ...
              <h2>What services do you want for your geyser?</h2>
              <div class="question_body">
                          <div class="form-group">
                                <label for="repair" class="switchery">Repair
                            ...
                            <div class="form-group">
                                <label for="uninstallation" class="switchery">Uninstallation
                                    <input id="uninstallation" checked="" type="radio" name="uninstallation" value="Uninstallation" ng-true-value="'Uninstallation'" ng-false-value="''" class="" ng-model="mainformParams.gender" required ng-class="{'input-error': formValidation && MainMultiStepForm.gender.$error.required}">
                                    <span  class="checkmark "></span>
                                </label>
                            </div>
      ...
      <div class="animate-switch-container" ng-switch on="stage" ng-class="{forward: direction, backward:!direction}">
        ...
        <div class="animate-switch1" ng-switch-when="stage2">
          ...
          <div class="row">
              ...
              <div class="question_body">
                          <div class="form-group">
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Repair - Rs. 249</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Complete diagnosis of geyser</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Identifying problems like heating element issue, leakage, etc</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Visiting charge of Rs.249 if you decide to not go ahead with the repair</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Installation - Rs. 499</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Installation of Geyser unit</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Complete performance check post installation</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Uninstallation - Rs. 399</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Complete check before un-installation</p>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Removal and un-installation of unit</p>
                                <h3 class="switchery" style="font-size: 20px;text-align: left;">Advantages</h3>
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> Background checked and highly trained technicians</p>
                                ...
                                <p class="prefpack_p"><i class="fa fa-check" aria-hidden="true" style="color: #3c763d;"></i> <a href="#">Genuine parts & fixed pricing</a></p>
