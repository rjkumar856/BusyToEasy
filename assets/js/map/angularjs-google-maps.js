            ...
            controller: ['$scope', '$element', '$attrs', '$transclude', function($scope, $element, $attrs, $transclude){
                ...
                try {
                    var bangaloreBounds = new google.maps.LatLngBounds(new google.maps.LatLng(12.864162, 77.438610),new google.maps.LatLng(13.139807, 77.711895));
                           //var location = new google.maps.LatLng(12.9715987, 77.5945626999);
                           var map_options = { bounds: bangaloreBounds,types: ['geocode'],componentRestrictions: {country: "in"},strictBounds: true,radius: 3000 };
                    //this._api = new google.maps.places.Autocomplete(this._element, this._options);
                    this._api = new google.maps.places.Autocomplete(this._element, map_options);
                }
                catch (err)
                {
