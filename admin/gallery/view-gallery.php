...
if(isset($_GET['delete_id'])){
	...
	$stmt = $reg_user->runQuery("DELETE FROM galleries WHERE id=".$_GET['delete_id']);
...
<div class="site-content">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4>View Gallery List</h4>
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="#">Home</a></li>
							<li class="breadcrumb-item active">Gallery List</li>
						</ol>
						<div class="box box-block bg-white">
							<h5 class="mb-1">Exporting Gallery List Data</h5>
							<table class="table jsgrid table-striped table-bordered dataTable table-responsive" id="table-2">
								...
								<tbody>
                                    <?php
                                    $stmt = $reg_user->runQuery("SELECT * FROM galleries ORDER BY date_added DESC");
                                    $stmt->execute();
                                    ...
                                    <td class="jsgrid-cell jsgrid-control-field jsgrid-align-center" style="width: 50px;">
    										...
    										<td><?php echo "<img src='../assets/files/gallery/$stmt1->image' width='70'>";?></td>
...
function delete_id(id)
{
	...
	{
		window.location.href='view-gallery?delete_id='+id;
	}
}
</script>