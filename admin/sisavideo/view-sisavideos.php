...
if(isset($_GET['delete_id'])){
	...
	$stmt = $reg_user->runQuery("DELETE FROM siasa_videos WHERE id=".$_GET['delete_id']);
...
<div class="site-content">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4>View SISA Video List</h4>
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="#">Home</a></li>
							<li class="breadcrumb-item active">View SISA Video List</li>
						</ol>
						<div class="box box-block bg-white">
							<h5 class="mb-1">Exporting View SISA Videos Data</h5>
							<table class="table jsgrid table-striped table-bordered dataTable table-responsive" id="table-2">
								...
								<tbody>
                                    <?php
                                    $stmt = $reg_user->runQuery("SELECT * FROM siasa_videos ORDER BY id");
                                    $stmt->execute();
									$counter = 0;
                                    ...
                                    <td class="jsgrid-cell jsgrid-control-field jsgrid-align-center" style="width: 50px;">
    										<a href="edit-sisavideos-list?id=<?php echo $stmt1->id;?>"><button class="jsgrid-button jsgrid-edit-button" type="button" title="Edit"></button></a>
...
function delete_id(id)
{
	...
	{
		window.location.href='view-sisavideos?delete_id='+id;
	}
}
</script>