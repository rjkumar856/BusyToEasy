...
if(isset($_GET['id'])){
    ...
    header("Location: view-mains-results");
}
            ...
            $FileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
                if($FileType == 'pdf'){
                    ...
                    if(move_uploaded_file($_FILES["result_file"]["tmp_name"], $target_file_new)){
                        $stmt = $reg_user->runQuery("UPDATE online_test_mains_submission SET corrected_file='$file_name' WHERE id='$requested_id'");
                        $stmt->execute();
                        
                		$_SESSION['add_user_error_msg'] = "<div class='alert alert-success'><button class='close' data-dismiss='alert'>&times;</button><strong>Mains Test Corrected File!</strong> Uploaded Successfully.</div>";
                		header("Location: upload-mains-corrected-file?id=".$requested_id);
                		exit();
                		exit();
                    } else {
...
<div class="site-content">
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4>Upload Mains Test Corrected File</h4>
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="view-mains-results">Mains Test Result List</a></li>
							<li class="breadcrumb-item active"><a href="#">Mains Test Corrected File</a></li>
						</ol>
