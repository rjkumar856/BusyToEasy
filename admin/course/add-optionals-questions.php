            ...
            $FileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
                if($FileType == 'pdf'){
                    ...
                    if (move_uploaded_file($_FILES["result_file"]["tmp_name"], $target_file_new)){
                        ...
                        $stmt = $reg_user->runQuery("INSERT INTO online_test_optional(title,subject,file_url) 
                		...
                		header("Location: add-optionals-questions");
                		exit();
                    } else {
...
<div class="site-content">
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4>Add New Optional Test</h4>
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="view-optionals-questions">View Optional Test</a></li>
							<li class="breadcrumb-item active"><a href="#">Add New Optional Test</a></li>
						</ol>
							...
							<form class="form-horizontal" method="post" name="edit_ad" enctype="multipart/form-data">
								...
								<div class="col-md-6">
									<div class="form-group">
                                	    ...
                                	    <option <?php if(isset($_POST['subjects']) && $_POST['subjects'] == "Public Administration"){ echo "selected"; }else{ echo ""; } ?> value="Public Administration">Public Administration</option>
										<option <?php if(isset($_POST['subjects']) && $_POST['subjects'] == "Pshychology"){ echo "selected"; }else{ echo ""; } ?> value="Pshychology">Pshychology</option>
										<option <?php if(isset($_POST['subjects']) && $_POST['subjects'] == "Geography"){ echo "selected"; }else{ echo ""; } ?> value="Geography">Geography</option>
										<option <?php if(isset($_POST['subjects']) && $_POST['subjects'] == "Anthropology"){ echo "selected"; }else{ echo ""; } ?> value="Anthropology">Anthropology</option>
										<option <?php if(isset($_POST['subjects']) && $_POST['subjects'] == "History"){ echo "selected"; }else{ echo ""; } ?> value="History">History</option>
										<option <?php if(isset($_POST['subjects']) && $_POST['subjects'] == "Political Science"){ echo "selected"; }else{ echo ""; } ?> value="Political Science">Political Science</option>
										<option <?php if(isset($_POST['subjects']) && $_POST['subjects'] == "Sociology"){ echo "selected"; }else{ echo ""; } ?> value="Sociology">Sociology</option>
                                		</select>
                                	</div>
								</div>
								...
								<div class="col-md-12">
									<div class="pull-left">
									<input type="submit" class="btn btn-primary" value="Add Optional Test" name="cus_add_new_user">
									</div>
									</div>
						</div>
							</form>
