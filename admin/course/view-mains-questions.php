...
if(isset($_GET['delete_id'])){
	$stmt = $reg_user->runQuery("DELETE FROM online_test_mains WHERE id=".$_GET['delete_id']);
...
<div class="site-content">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4>Mains Test List</h4>
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="#">Home</a></li>
							<li class="breadcrumb-item active">View Mains Test</li>
						</ol>
						<div class="box box-block bg-white">
							<h5 class="mb-1">Exporting Mains Test Data</h5>
							<table class="table jsgrid table-striped table-bordered dataTable table-responsive" id="table-2">
								...
								<?php
								$count=1;
                                        $stmt = $reg_user->runQuery("SELECT *, otq.id as QID FROM online_test_mains otq ORDER BY otq.date_added DESC");
                                        $stmt->execute();
                                        for($i=0; $stmt1 = $stmt->fetchObject(); $i++){
                                        ?><tr>	
                                        <td class="jsgrid-cell jsgrid-control-field jsgrid-align-center" style="width: 60px;">
                                            <a href="edit-mains-question?id=<?php echo $stmt1->QID;?>"><button class="jsgrid-button jsgrid-edit-button" type="button" title="Edit"></button></a>
    									...
    									<td><?php echo $stmt1->subject;?></td>
    										<td><a href="../assets/files/mains/<?php echo $stmt1->file_url;?>" target="_blank"><i class="fa fa-download" aria-hidden="true"></i> Download</a></td>
		...
		function delete_id(id){
		    if(confirm('Are you sure you want to Delete this Test?')){
		        window.location.href='view-mains-questions?delete_id='+id;
		    }
		}
		</script>
		</body>
