            ...
            $FileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
                if($FileType == 'pdf'){
                    ...
                    if (move_uploaded_file($_FILES["result_file"]["tmp_name"], $target_file_new)){
                        ...
                        $stmt = $reg_user->runQuery("INSERT INTO notification_slider(title,file_url,file_links) 
                		...
                		header("Location: add-notification-slider");
                		exit();
                    } else {
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						...
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="view-notification-slider">Notification List</a></li>
						...
						<div class="box box-block bg-white">
							...
							<form name="news upload" id="news" action="" method="POST" enctype="multipart/form-data">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="title" id="title" value="<?php if(isset($_POST['title'])){ echo $_POST['title']; } ?>" placeholder="Enter the Notification content" required="required"/>
								</div>
								<div class="form-group">
