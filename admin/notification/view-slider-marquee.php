...
if(isset($_GET['delete_id'])){
	$stmt = $reg_user->runQuery("DELETE FROM moving_slider_marquee WHERE id=".$_GET['delete_id']);
	$stmt->execute(array(":id"=>$id));
	header("Location: view-slider-marquee");
}
...
<div class="site-content">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4>View Moving Slider Notification List</h4>
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="#">Home</a></li>
							<li class="breadcrumb-item active">Moving Slider Notification List</li>
						</ol>
						<div class="box box-block bg-white">
							<h5 class="mb-1">Exporting Moving Slider Notification List Data</h5>
							<table class="table jsgrid table-striped table-bordered dataTable table-responsive" id="table-2">
								...
								<tbody>
                                    <?php
                                    $stmt = $reg_user->runQuery("SELECT * FROM moving_slider_marquee ORDER BY date_added DESC");
                                    $stmt->execute();
									$counter = 0;
...
function delete_id(id)
{
	...
	{
		window.location.href='view-slider-marquee?delete_id='+id;
	}
}
</script>