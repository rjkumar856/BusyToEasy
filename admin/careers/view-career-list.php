				...
				<div class="content-area py-1">
					<div class="container-fluid">
						...
						<ol class="breadcrumb no-bg mb-1">
							...
							<li class="breadcrumb-item active">View Career Test</li>
						</ol>
						<div class="box box-block bg-white">
							...
							<table class="table jsgrid table-striped table-bordered dataTable table-responsive" id="table-2">
								...
								<?php
								$count=1;
                                $stmt = $reg_user->runQuery("SELECT * FROM career ORDER BY id");
                                $stmt->execute();
								...
								<td><?php echo $stmt1->employementtype;?></td>
								<td><?php echo $stmt1->role;?></td>
									<td><a href="../assets/files/resume/<?php echo $stmt1->resume_url;?>" target="_blank"><i class="fa fa-download" aria-hidden="true"></i> Download</a></td>
									<td><?php echo $stmt1->upload_time;?></td>
								</tr><?php $count++; } ?>
								</tbody>
							</table>
						</div>
