...
if(isset($_GET['delete_id'])){
	...
	$stmt = $reg_user->runQuery("DELETE FROM daily_current_affairs WHERE id=".$_GET['delete_id']);
...
<div class="site-content">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4>View Daily Current Affairs List</h4>
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="#">Home</a></li>
							<li class="breadcrumb-item active">Daily Current Affairs List</li>
						</ol>
						<div class="box box-block bg-white">
							<h5 class="mb-1">Exporting Daily Current Affairs Data</h5>
							<table class="table jsgrid table-striped table-bordered dataTable table-responsive" id="table-2">
								...
								<tbody>
                                    <?php
                                    $stmt = $reg_user->runQuery("SELECT * FROM daily_current_affairs ORDER BY date_added DESC");
                                    $stmt->execute();
									$counter = 0;
                                    ...
                                    <td class="jsgrid-cell jsgrid-control-field jsgrid-align-center" style="width: 50px;">
    										<a href="edit-daily-current-affair-list?id=<?php echo $stmt1->id;?>"><button class="jsgrid-button jsgrid-edit-button" type="button" title="Edit"></button></a>
...
function delete_id(id)
{
	...
	{
		window.location.href='view-daily-current-affair?delete_id='+id;
	}
}
</script>